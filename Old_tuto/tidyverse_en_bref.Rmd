...
NOTE: Chargez tous vos packages au début du script (ici ce n'est qu'un
exemple)
...
**Il y a tellement de cas pratique, mais nous allons voir 2 cas avec
map**
...
**Nous aurons aussi besoin de la librairie ggplot2 pour certains
exemples**
